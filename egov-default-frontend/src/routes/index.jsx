...
import InventoryEdit from 'pages/product/InventoryEdit';
...
const SecondRoutes = () => {
  ...
  return (
    <>
      <EgovHeader />
      <Routes>
          <Route path="/order/orders" element={<OrderList />} />
          <Route path="/order/OrderEdit" element={<OrderEdit />} />
          <Route path="/order/OrderDetail" element={<OrderDetail />} />

          <Route path="/product/inventories" element={<InventoryList />} />
          <Route path="/product/InventoryEdit" element={<InventoryEdit />} />
          <Route path="/product/InventoryDetail" element={<InventoryDetail />} />
