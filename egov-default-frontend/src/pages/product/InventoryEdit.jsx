...
function EgovNoticeEdit(props) {
    ...
    const updateBoard = () => {
        ...
        const entity = {
            id: boardDetail.id,
            productName: boardDetail.productName,
            stock: boardDetail.stock
        };

        axios.post('/inventories', entity)
        .then(response => {
        ...
        return (
            <div className="location">
                <ul>
                    ...
                    <li><Link to="/product/inventories">Inventory</Link></li>
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">Inventory</h1>
                        </div>
                        ...
                        <div className="board_view2">
                            ...
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">ProductName</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="productName" name="productName" type="text"
                                        onChange={e => setBoardDetail({ ...boardDetail, productName: e.target.value })}
                                        maxLength="60" />
                                </dd>
                            </dl>
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">Stock</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="stock" name="stock" type="text"
                                        onChange={e => setBoardDetail({ ...boardDetail, stock: e.target.value })}
                                        maxLength="60" />
                                </dd>
                            </dl>
                            {/* <!-- 버튼영역 --> */}
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to="/product/inventories" className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
